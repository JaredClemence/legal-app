...
class Product extends ApiBaseClass {
    static public $categoryOptions = [
        ...
        "COMMERCIAL_SPORTS_PROFESSIONAL",
    ...
    static public $typeChoices = ["PHYSICAL", "DIGITAL", "SERVICE"];
    ...
    public function setCategory($category){
        $this->validateEnumratedOption($category, self::$categoryOptions);
        $this->category = $category;
    }
    public function setPayee(Payee $payee){
        $this->payee = $payee;
    }
    public function setPayeeByAttr($merchant_id, $display_data){
        $payee = new Payee();
        $payee->setMerchantId($merchant_id);
        $payee->setDisplayData($display_data);
        $this->setPayee($payee);
        return $this;
    }
    public function setCreateTime($timeString){
        $this->create_time = $timeString;
    }
    public function setUpdateTime($timeString){
        $this->update_time = $timeString;
    }
}
